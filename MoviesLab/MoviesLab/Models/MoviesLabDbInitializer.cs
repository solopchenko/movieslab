...
namespace MoviesLab.Models
{
    public class MoviesLabDbInitializer : DropCreateDatabaseAlways<MoviesLabDbContext>
    {
        protected override void Seed(MoviesLabDbContext db)
        {
            ...
            var admin = new MoviesLabUser { UserName = "admin", Name = "Администратор", Surname = "Сайта" };
            ...
            var user = new MoviesLabUser { UserName = "user", Name = "Обычный", Surname = "Пользователь" };
            password = "password";
